...
**200 OK — Sync Completed** _(run finished within 60 seconds)_
...
- Server waits up to **60 seconds** for the run to complete.
...
- Suitable for long-running grids (\> 60 seconds).
...
Client                              BitScale API
  ...
  │                                     │   (waits up to 60s)
  │                                     │
  │◀── 200 OK { status: 'completed', ───│  (success within 60s)
  │            outputs: {...} }          │
  │                                     │
  │◀── 200 OK { status: 'running',  ────│  (timeout after 60s)
  │            request_id: '...',        │
  │            poll_url: '...' }         │
  │                                     │
