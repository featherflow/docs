...
description: "Learn how to use Bitscale’s Find People from Company enrichment to turn account lists into enriched, campaign-ready contact lists. Map companies to your target personas, apply unique filters like tenure and total experience, export contacts into dedicated grids, and reuse the setup for ongoing outreach."
---

### Overview


<iframe width="100%" style={{aspectRatio: "16/9"}} src="https://www.youtube.com/embed/2a8YBM0M2J8?si=9BMVuw-h3N7R78hB" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
