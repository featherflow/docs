...
description: "Sync Google Sheets into Bitscale automatically using a lightweight Apps Script. SDRs keep working in Sheets while Bitscale ingests new rows in near–realtime via webhooks."
---

### Overview

<iframe width="100%" style={{aspectRatio: "16/9"}} src="https://www.youtube.com/embed/Ya90I3J64a8?si=6G5IxZXAYXg6MGVs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
