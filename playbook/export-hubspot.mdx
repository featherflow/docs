---
title: 'Exporting Data Back to HubSpot'
...
__HubSpot__ (Where the magic happens)

## Flow of Data:

___Data Processing___ (Get the data ready, Hopefully on one of our highly capable grids) → ___HubSpot___ (Export the new and improved data)
