...
description: 'Note: str2 can be replaced by any column by putting {{ @column_name }} in place of it'
---


_The formulae mentioned are simply js inline scripts. To generate any other formulae one can just ask chatgpt to generate the same._

_You can use the below prompt for this:_
```
